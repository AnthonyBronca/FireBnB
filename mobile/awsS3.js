...
function uploadFilesToS3(files) {
    return __awaiter(this, void 0, void 0, function () {
        var s3Client, S3_BUCKET, _i, files_1, file, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    s3Client = new client_s3_1.S3Client({ region: 'us-east-2' });
                    S3_BUCKET = 'demo-firebnb-s3';
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    _i = 0, files_1 = files;
                ...
                case 3:
                    _a.sent();
                    console.log("Upload successful for file: ".concat(file.Key));
                    _a.label = 4;
                case 4:
                    _i++;
                    return [3 /*break*/, 2];
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error("There was an error uploading to S3:", error_1);
                    throw error_1;
